...
#<_rc_alignment> = 0
(print,Alignment: #<_rc_alignment>)

; The direction of travel from pocket 1 to pocket 2: 1 = Positive, -1 = Negative.
#<_rc_direction> = 1
(print,Direction: #<_rc_direction>)

; The X an Y machine coordinate positions of pocket 1.
#<_rc_pocket_one_x> = 212.1
(print,Pocket 1 X: #<_rc_pocket_one_x>)

#<_rc_pocket_one_y> = 72.6
(print,Pocket 1 Y: #<_rc_pocket_one_y>)
